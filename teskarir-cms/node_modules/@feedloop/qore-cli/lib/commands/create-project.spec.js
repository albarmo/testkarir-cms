...
describe("create-project", () => {
    ...
    it("should be able to export schema", async () => {
        ...
        await expect(create_project_1.default.run([
            ...
            projectName
        ])).rejects.toThrowError('"some-unknown-template" is not a valid template, please check if it is a qore project or choose from the following available templates: todo-list-typescript');
        completeRecording();
    });
});
