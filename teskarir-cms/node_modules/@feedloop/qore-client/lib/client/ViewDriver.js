    ...
    FormDriver.prototype.sendForm = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.project.axios.post("/" + this.viewId + "/forms/" + this.formId, params)];
                    case 1:
                        resp = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        uploadUrl = _a.sent();
                        return [4 /*yield*/, axios_1.default.put(uploadUrl, file, {
                                headers: {
