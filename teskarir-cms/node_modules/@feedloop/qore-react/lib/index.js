    ...
    const useCurrentUser = () => {
        ...
        react_1.default.useEffect(() => {
            (() => __awaiter(void 0, void 0, void 0, function* () {
                setStatus("loading");
                try {
                    const user = yield qoreClient.currentUser();
                    setUser(user);
                    setStatus("success");
                }
                catch (error) {
    ...
    function createViewHooks(currentViewId) {
        ...
        return {
            ...
            useForm: (formId) => {
                ...
                const [status, setStatus] = react_1.default.useState("idle");
                const [error, setError] = react_1.default.useState(null);
                const send = react_1.default.useCallback((params) => __awaiter(this, void 0, void 0, function* () {
                    try {
                        setStatus("loading");
                        const resp = yield form.sendForm(params);
                        setError(null);
                        setStatus("success");
                        return resp;
                    }
