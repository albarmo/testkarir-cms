...
describe("Provider", () => {
    it("should work with provider", () => {
        ...
        const { result } = react_hooks_1.renderHook(() => qoreContext.useClient(), {
            wrapper: (props) => (react_1.default.createElement(qoreContext.context.Provider, { value: { client: otherQoreContext.client } }, props.children))
        });
...
describe("useGetRow", () => {
    it("should fetch data successfully", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const qoreContext = createNewQoreContext();
        const { result, waitForNextUpdate } = react_hooks_1.renderHook(() => qoreContext
            .view("allTasks")
...
describe("useActions", () => {
    it("should trigger action", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const qoreContext = createNewQoreContext();
        const { result } = react_hooks_1.renderHook(() => qoreContext
            .view("allTasks")
            .useActions("beba4104-44ee-46b2-9ddc-e6bfd0a1570f"));
        expect(result.current.statuses.finishTask).toEqual("idle");
        yield react_hooks_1.act(() => __awaiter(void 0, void 0, void 0, function* () {
            yield expect(result.current.action("finishTask").trigger({ notes: "some notes" })).resolves.toEqual(true);
        }));
...
describe("useRelation", () => {
    it("should add & remove relation", () => __awaiter(void 0, void 0, void 0, function* () {
        scope = scope
            .post("/FAKE_PROJECT/allTasks/rows/beba4104-44ee-46b2-9ddc-e6bfd0a1570f/person/some-person-id")
            .reply(200, { isExecuted: true })
            .delete("/FAKE_PROJECT/allTasks/rows/beba4104-44ee-46b2-9ddc-e6bfd0a1570f/person/some-person-id")
            .reply(200, { isExecuted: true });
        const qoreContext = createNewQoreContext();
        const { result } = react_hooks_1.renderHook(() => qoreContext.views.allTasks.useRelation("beba4104-44ee-46b2-9ddc-e6bfd0a1570f"));
        expect(result.current.statuses.addRelation).toEqual("idle");
        expect(result.current.statuses.removeRelation).toEqual("idle");
        yield react_hooks_1.act(() => __awaiter(void 0, void 0, void 0, function* () {
            yield expect(result.current.addRelation({ person: ["some-person-id"] })).resolves.toEqual(true);
            yield expect(result.current.removeRelation({ person: ["some-person-id"] })).resolves.toEqual(true);
        }));
...
describe("useForm", () => {
    it("should send form", () => __awaiter(void 0, void 0, void 0, function* () {
        scope = scope
            .post("/FAKE_PROJECT/allTasks/forms/newTask")
            .reply(200, { id: "new-task-id" });
        const qoreContext = createNewQoreContext();
        const { result } = react_hooks_1.renderHook(() => qoreContext.views.allTasks.useForm("newTask"));
        expect(result.current.status).toEqual("idle");
        yield react_hooks_1.act(() => __awaiter(void 0, void 0, void 0, function* () {
            const resp = yield result.current.send({ title: "New task" });
...
describe("useCurrentUser", () => {
    it("should fetch current user", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const qoreContext = createNewQoreContext();
        const { result, waitForValueToChange } = react_hooks_1.renderHook(() => qoreContext.useCurrentUser());
        yield waitForValueToChange(() => result.current.user);
        expect(result.current.status).toEqual("success");
